...
Remeber asking for date is to state your intentions to have a relaitonship with them in the most respectable way possible an expect a response. If the response is positive, you can move on to build one with them, if negative, you could stay out.
